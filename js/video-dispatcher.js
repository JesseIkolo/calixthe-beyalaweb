...
mook_video.forEach(element => {
    ...
    video_side.innerHTML+=`<div class="column services-list__item video-list-lateral">
<div class="ads-block video-content">
                        <div class="cover">
                            <a class="bkg" href=`+ element.video_link +` style="background-image:url(`+ element.cover_photo+`); background-size:cover;"></a>
                        ...
                        <a class="description" href="`+element.video_link+`">`+element.title+`</a>
                        <div class="details">
